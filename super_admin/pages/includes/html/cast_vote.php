...
if(isset($_POST['submit'])){
    ...
    $check_query = User::find_by_sql("SELECT * FROM `voted_students` WHERE rnumber='$session_student' ");
    ...
    if(isset($_POST['president'])){
        ...
        if($start_president == "yes"){
            ...
            $query = User::find_by_sql("SELECT * FROM voting_system WHERE rnumber='$president_rnumber' ");
           
            while ( $row = mysqli_fetch_array($query) ) {	
                $eligibility = $row['eligibility'];
                $new_eligibility = $eligibility + 1;
            }
            $query = User::find_by_sql("UPDATE `voting_system` SET `eligibility` = '$new_eligibility' WHERE `rnumber` = '$president_rnumber' ");
            ...
            $query = User::find_by_sql("UPDATE `voting_system` SET `ineligibility` = '$new_ineligibility' WHERE `rnumber` = '$president_rnumber' ");
    ...
    if(isset($_POST['vice_president'])){
        ...
        $query = User::find_by_sql("SELECT * FROM `voting_system` WHERE `rnumber` = '$vice_president_rnumber' ");
            
        while ( $row = mysqli_fetch_array($query) ) {	
            $eligibility = $row['eligibility'];
            $new_eligibility = $eligibility + 1;
        }
        $query = User::find_by_sql("UPDATE `voting_system` SET `eligibility` = '$new_eligibility' WHERE `rnumber` = '$vice_president_rnumber' ");
        ...
        $query = User::find_by_sql("UPDATE `voting_system` SET `ineligibility` = '$new_ineligibility' WHERE `rnumber` = '$vice_president_rnumber' ");

    }
    }
    if(isset($_POST['secretary_general'])){
        ...
        if($start_secretary_general == "yes"){
            ...
            $query = User::find_by_sql("SELECT * FROM voting_system WHERE `rnumber` = '$secretary_general_rnumber' ");
            while ( $row = mysqli_fetch_array($query) ) {	
                $eligibility = $row['eligibility'];
                $new_eligibility = $eligibility + 1;
            }
            $query = User::find_by_sql("UPDATE `voting_system` SET `eligibility` = '$new_eligibility' WHERE `rnumber` = '$secretary_general_rnumber' ");
            ...
            $query = User::find_by_sql("UPDATE `voting_system` SET `ineligibility` = '$new_ineligibility' WHERE `rnumber` = '$secretary_general_rnumber' ");
    ...
    if(isset($_POST['financial_secretary'])){
        ...
        if($start_financial_secretary == "yes"){
            ...
            $query = User::find_by_sql("SELECT * FROM voting_system WHERE `rnumber` = '$financial_secretary_rnumber' ");
            while ( $row = mysqli_fetch_array($query) ) {	
                $eligibility = $row['eligibility'];
                $new_eligibility = $eligibility + 1;
            }
            $query = User::find_by_sql("UPDATE `voting_system` SET `eligibility` = '$new_eligibility' WHERE `rnumber` = '$financial_secretary_rnumber' ");
            ...
            $query = User::find_by_sql("UPDATE `voting_system` SET `ineligibility` = '$new_ineligibility' WHERE `rnumber` = '$financial_secretary_rnumber' ");
            
        }
    }
    if(isset($_POST['social_1'])){
        ...
        if($start_social_1 == "yes"){
            ...
            $query = User::find_by_sql("SELECT * FROM voting_system WHERE `rnumber` = '$social_1_rnumber' ");
            while ( $row = mysqli_fetch_array($query) ) {	
                $eligibility = $row['eligibility'];
                $new_eligibility = $eligibility + 1;
            }
            $query = User::find_by_sql("UPDATE `voting_system` SET `eligibility` = '$new_eligibility' WHERE `rnumber` = '$social_1_rnumber' ");
            ...
            $query = User::find_by_sql("UPDATE `voting_system` SET `ineligibility` = '$new_ineligibility' WHERE `rnumber` = '$social_1_rnumber' ");
            
        }
    }
    if(isset($_POST['social_2'])){
        ...
        if($start_social_2 == "yes"){
            ...
            $query = User::find_by_sql("SELECT * FROM voting_system WHERE `rnumber` = '$social_2_rnumber' ");
            while ( $row = mysqli_fetch_array($query) ) {	
                $eligibility = $row['eligibility'];
                $new_eligibility = $eligibility + 1;
            }
            $query = User::find_by_sql("UPDATE `voting_system` SET `eligibility` = '$new_eligibility' WHERE `rnumber` = '$social_2_rnumber' ");
            ...
            $query = User::find_by_sql("UPDATE `voting_system` SET `ineligibility` = '$new_ineligibility' WHERE `rnumber` = '$social_2_rnumber' ");
            
        }
    }
    if(isset($_POST['software_1'])){
        ...
        if($start_software_1 == "yes"){
            ...
            $query = User::find_by_sql("SELECT * FROM voting_system WHERE `rnumber` = '$software_1_rnumber' ");
            while ( $row = mysqli_fetch_array($query) ) {	
                $eligibility = $row['eligibility'];
                $new_eligibility = $eligibility + 1;
            }
            $query = User::find_by_sql("UPDATE `voting_system` SET `eligibility` = '$new_eligibility' WHERE `rnumber` = '$software_1_rnumber' ");
            ...
            $query = User::find_by_sql("UPDATE `voting_system` SET `ineligibility` = '$new_ineligibility' WHERE `rnumber` = '$software_1_rnumber' ");
            
        }
    }
    if(isset($_POST['software_2'])){
        ...
        if($start_software_2 == "yes"){
            ...
            $query = User::find_by_sql("SELECT * FROM voting_system WHERE `rnumber` = '$software_2_rnumber' ");
            while ( $row = mysqli_fetch_array($query) ) {	
                $eligibility = $row['eligibility'];
                $new_eligibility = $eligibility + 1;
            }
            $query = User::find_by_sql("UPDATE `voting_system` SET `eligibility` = '$new_eligibility' WHERE `rnumber` = '$software_2_rnumber' ");
            ...
            $query = User::find_by_sql("UPDATE `voting_system` SET `ineligibility` = '$new_ineligibility' WHERE `rnumber` = '$software_2_rnumber' ");
            
        }
    }
    if(isset($_POST['academics_1'])){
        ...
        if($start_academics_1 == "yes"){
            ...
            $query = User::find_by_sql("SELECT * FROM voting_system WHERE `rnumber` = '$academics_1_rnumber' ");
            while ( $row = mysqli_fetch_array($query) ) {	
                $eligibility = $row['eligibility'];
                $new_eligibility = $eligibility + 1;
            }
            $query = User::find_by_sql("UPDATE `voting_system` SET `eligibility` = '$new_eligibility' WHERE `rnumber` = '$academics_1_rnumber' ");
            ...
            $query = User::find_by_sql("UPDATE `voting_system` SET `ineligibility` = '$new_ineligibility' WHERE `rnumber` = '$academics_1_rnumber' ");
            
        }
    }
    if(isset($_POST['academics_2'])){
        ...
        if($start_academics_2 == "yes"){
            ...
            $query = User::find_by_sql("SELECT * FROM voting_system WHERE `rnumber` = '$academics_2_rnumber' ");
            while ( $row = mysqli_fetch_array($query) ) {	
                $eligibility = $row['eligibility'];
                $new_eligibility = $eligibility + 1;
            }
            $query = User::find_by_sql("UPDATE `voting_system` SET `eligibility` = '$new_eligibility' WHERE `rnumber` = '$academics_2_rnumber' ");
            ...
            $query = User::find_by_sql("UPDATE `voting_system` SET `ineligibility` = '$new_ineligibility' WHERE `rnumber` = '$academics_2_rnumber' ");
    ...
    if(isset($_POST['librarian'])){
        ...
        if($start_librarian == "yes"){
            ...
            $query = User::find_by_sql("SELECT * FROM voting_system WHERE `rnumber` = '$librarian_rnumber' ");
            while ( $row = mysqli_fetch_array($query) ) {	
                $eligibility = $row['eligibility'];
                $new_eligibility = $eligibility + 1;
            }
            $query = User::find_by_sql("UPDATE `voting_system` SET `eligibility` = '$new_eligibility' WHERE `rnumber` = '$librarian_rnumber' ");
            ...
            $query = User::find_by_sql("UPDATE `voting_system` SET `ineligibility` = '$new_ineligibility' WHERE `rnumber` = '$librarian_rnumber' ");
    ...
    if(isset($_POST['provost'])){
        ...
        if($start_provost == "yes"){
            ...
            $query = User::find_by_sql("SELECT * FROM voting_system WHERE `rnumber` = '$provost_rnumber' ");
            while ( $row = mysqli_fetch_array($query) ) {	
                $eligibility = $row['eligibility'];
                $new_eligibility = $eligibility + 1;
            }
            $query = User::find_by_sql("UPDATE `voting_system` SET `eligibility` = '$new_eligibility' WHERE `rnumber` = '$provost_rnumber' ");
            ...
            $query = User::find_by_sql("UPDATE `voting_system` SET `ineligibility` = '$new_ineligibility' WHERE `rnumber` = '$provost_rnumber' ");
            
        }
    }
    
            $insert_query = User::find_by_sql("INSERT INTO `voted_students` SET `rnumber`='$rnumber', level='$level', `full_name`='$full_name', date=NOW() ");
            if($insert_query){
                ?>
...
<?php
$query = User::find_by_sql("SELECT * FROM `voting_system` WHERE post='president' ");
...
<?php
$query = User::find_by_sql("SELECT * FROM `voting_system` WHERE post='vice_president' ");
...
<?php if(mysqli_num_rows($query)==1){ ?>
 ...
 <?php
$query = User::find_by_sql("SELECT * FROM `voting_system` WHERE post='secretary_general' ");
...
<?php if(mysqli_num_rows($query)==1){ ?>
                                    ...
                                    <tr>
                                        ...
                                        <td ><input type="radio" name="secretary_general" value="<?php echo "yes"."_".$secretary_general_rnumber; ?>" ></td>
                                        <td ><input type="radio" name="secretary_general" value="<?php echo "no"."_".$secretary_general_rnumber; ?>"></td>
                                    </tr>
    ...
    ?>
                                    ...
                                    <tr>
                                        <td><h5 ><?php echo $counter_secretary_general;?></h5></td>
                                        <td><h4><?php echo $secretary_general_fullname; ?></h4></td>
                                        <td colspan="2"><input type="radio" name="secretary_general" value="<?php echo "yes"."_".$secretary_general_rnumber; ?>" ></td>
                                    </tr>
...
<?php
$query = User::find_by_sql("SELECT * FROM `voting_system` WHERE post='financial_secretary' ");
...
<?php
$query = User::find_by_sql("SELECT * FROM `voting_system` WHERE post='social_1' ");
$counter_social_1=1;
$result = mysqli_num_rows($query);
if(!empty($result)){
?>                                 
...
<?php                                
$query = User::find_by_sql("SELECT * FROM `voting_system` WHERE post='social_2' ");
$counter_social_2=1;
$result = mysqli_num_rows($query);
if(!empty($result)){
?>                                 
...
<?php
$query = User::find_by_sql("SELECT * FROM `voting_system` WHERE post='software_1' ");
...
<?php
$query = User::find_by_sql("SELECT * FROM `voting_system` WHERE post='software_2' ");
...
<?php
$query = User::find_by_sql("SELECT * FROM `voting_system` WHERE post='academics_1' ");
...
<?php
$query = User::find_by_sql("SELECT * FROM `voting_system` WHERE post='academics_2' ");
...
<?php
$query = User::find_by_sql("SELECT * FROM `voting_system` WHERE post='librarian' ");
$counter_librarian=1;
$result = mysqli_num_rows($query);
if(!empty($result)){
?>                                 
...
<?php
$query = User::find_by_sql("SELECT * FROM `voting_system` WHERE post='provost' ");
$counter_provost=1;
$result = mysqli_num_rows($query);
if(!empty($result)){
?>                                 
...
<?php $query = User::find_by_sql("SELECT * FROM `voting_system`"); if(mysqli_num_rows($query)>0){ ?>                             
