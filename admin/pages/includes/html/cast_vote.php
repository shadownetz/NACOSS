...
if(isset($_POST['submit'])){
    ...
    $check_query = mysqli_query($dbconnect, "SELECT * FROM `voted_students` WHERE rnumber='$session_student' ");
    ...
    $president = mysqli_real_escape_string($dbconnect, $_POST['president']);
    $vice_president = mysqli_real_escape_string($dbconnect, $_POST['vice_president']);
    $secretary_general = mysqli_real_escape_string($dbconnect, $_POST['secretary_general']);
    $financial_secretary = mysqli_real_escape_string($dbconnect, $_POST['financial_secretary']);
    $social_1 = mysqli_real_escape_string($dbconnect, $_POST['social_1']);
    $social_2 = mysqli_real_escape_string($dbconnect, $_POST['social_2']);
    $software_1 = mysqli_real_escape_string($dbconnect, $_POST['software_1']);
    $software_2 = mysqli_real_escape_string($dbconnect, $_POST['software_2']);
    $academics_1 = mysqli_real_escape_string($dbconnect, $_POST['academics_1']);
    $academics_2 = mysqli_real_escape_string($dbconnect, $_POST['academics_2']);
    $librarian = mysqli_real_escape_string($dbconnect, $_POST['librarian']);
    $provost = mysqli_real_escape_string($dbconnect, $_POST['provost']);
    ...
    $start_president = $explode_president[0];
        if($start_president == "yes"){
            ...
            $query = mysqli_query($dbconnect, "SELECT * FROM voting_system WHERE rnumber='$president_rnumber' ");
           
            while ( $row = mysqli_fetch_array($query) ) {	
                $eligibility = $row['eligibility'];
                $new_eligibility = $eligibility + 1;
            }
            $query = mysqli_query($dbconnect, "UPDATE `voting_system` SET `eligibility` = '$new_eligibility' WHERE `rnumber` = '$president_rnumber' ");
            ...
            $query = mysqli_query($dbconnect, "UPDATE `voting_system` SET `ineligibility` = '$new_ineligibility' WHERE `rnumber` = '$president_rnumber' ");
    ...
    $start_vice_president = $explode_vice_president[0];
        ...
        $query = mysqli_query($dbconnect, "SELECT * FROM `voting_system` WHERE `rnumber` = '$vice_president_rnumber' ");
            
        while ( $row = mysqli_fetch_array($query) ) {	
            $eligibility = $row['eligibility'];
            $new_eligibility = $eligibility + 1;
        }
        $query = mysqli_query($dbconnect, "UPDATE `voting_system` SET `eligibility` = '$new_eligibility' WHERE `rnumber` = '$vice_president_rnumber' ");
        ...
        $query = mysqli_query($dbconnect, "UPDATE `voting_system` SET `ineligibility` = '$new_ineligibility' WHERE `rnumber` = '$vice_president_rnumber' ");
    ...
    $start_secretary_general = $explode_secretary_general[0];
        if($start_secretary_general == "yes"){
            ...
            $query = mysqli_query($dbconnect, "SELECT * FROM `voting_system` WHERE `rnumber` = '$secretary_general_rnumber' ");
            while ( $row = mysqli_fetch_array($query) ) {	
                $eligibility = $row['eligibility'];
                $new_eligibility = $eligibility + 1;
            }
            $query = mysqli_query($dbconnect, "UPDATE `voting_system` SET `eligibility` = '$new_eligibility' WHERE `rnumber` = '$secretary_general_rnumber' ");
            ...
            $query = mysqli_query($dbconnect, "UPDATE `voting_system` SET `ineligibility` = '$new_ineligibility' WHERE `rnumber` = '$secretary_general_rnumber' ");
    ...
    $start_financial_secretary = $explode_financial_secretary[0];
        if($start_financial_secretary == "yes"){
            ...
            $query = mysqli_query($dbconnect, "SELECT * FROM `voting_system` WHERE `rnumber` = '$financial_secretary_rnumber' ");
            while ( $row = mysqli_fetch_array($query) ) {	
                $eligibility = $row['eligibility'];
                $new_eligibility = $eligibility + 1;
            }
            $query = mysqli_query($dbconnect, "UPDATE `voting_system` SET `eligibility` = '$new_eligibility' WHERE `rnumber` = '$financial_secretary_rnumber' ");
            ...
            $query = mysqli_query($dbconnect, "UPDATE `voting_system` SET `ineligibility` = '$new_ineligibility' WHERE `rnumber` = '$financial_secretary_rnumber' ");
    ...
    $start_social_1 = $explode_social_1[0];
        if($start_social_1 == "yes"){
            ...
            $query = mysqli_query($dbconnect, "SELECT * FROM `voting_system` WHERE `rnumber` = '$social_1_rnumber' ");
            while ( $row = mysqli_fetch_array($query) ) {	
                $eligibility = $row['eligibility'];
                $new_eligibility = $eligibility + 1;
            }
            $query = mysqli_query($dbconnect, "UPDATE `voting_system` SET `eligibility` = '$new_eligibility' WHERE `rnumber` = '$social_1_rnumber' ");
            ...
            $query = mysqli_query($dbconnect, "UPDATE `voting_system` SET `ineligibility` = '$new_ineligibility' WHERE `rnumber` = '$social_1_rnumber' ");
    ...
    $start_social_2 = $explode_social_2[0];
        if($start_social_2 == "yes"){
            ...
            $query = mysqli_query($dbconnect, "SELECT * FROM `voting_system` WHERE `rnumber` = '$social_2_rnumber' ");
            while ( $row = mysqli_fetch_array($query) ) {	
                $eligibility = $row['eligibility'];
                $new_eligibility = $eligibility + 1;
            }
            $query = mysqli_query($dbconnect, "UPDATE `voting_system` SET `eligibility` = '$new_eligibility' WHERE `rnumber` = '$social_2_rnumber' ");
            ...
            $query = mysqli_query($dbconnect, "UPDATE `voting_system` SET `ineligibility` = '$new_ineligibility' WHERE `rnumber` = '$social_2_rnumber' ");
    ...
    $start_software_1 = $explode_software_1[0];
        if($start_software_1 == "yes"){
            ...
            $query = mysqli_query($dbconnect, "SELECT * FROM `voting_system` WHERE `rnumber` = '$software_1_rnumber' ");
            while ( $row = mysqli_fetch_array($query) ) {	
                $eligibility = $row['eligibility'];
                $new_eligibility = $eligibility + 1;
            }
            $query = mysqli_query($dbconnect, "UPDATE `voting_system` SET `eligibility` = '$new_eligibility' WHERE `rnumber` = '$software_1_rnumber' ");
            ...
            $query = mysqli_query($dbconnect, "UPDATE `voting_system` SET `ineligibility` = '$new_ineligibility' WHERE `rnumber` = '$software_1_rnumber' ");
    ...
    $start_software_2 = $explode_software_2[0];
        if($start_software_2 == "yes"){
            ...
            $query = mysqli_query($dbconnect, "SELECT * FROM `voting_system` WHERE `rnumber` = '$software_2_rnumber' ");
            while ( $row = mysqli_fetch_array($query) ) {	
                $eligibility = $row['eligibility'];
                $new_eligibility = $eligibility + 1;
            }
            $query = mysqli_query($dbconnect, "UPDATE `voting_system` SET `eligibility` = '$new_eligibility' WHERE `rnumber` = '$software_2_rnumber' ");
            ...
            $query = mysqli_query($dbconnect, "UPDATE `voting_system` SET `ineligibility` = '$new_ineligibility' WHERE `rnumber` = '$software_2_rnumber' ");
    ...
    $start_academics_1 = $explode_academics_1[0];
        if($start_academics_1 == "yes"){
            ...
            $query = mysqli_query($dbconnect, "SELECT * FROM `voting_system` WHERE `rnumber` = '$academics_1_rnumber' ");
            while ( $row = mysqli_fetch_array($query) ) {	
                $eligibility = $row['eligibility'];
                $new_eligibility = $eligibility + 1;
            }
            $query = mysqli_query($dbconnect, "UPDATE `voting_system` SET `eligibility` = '$new_eligibility' WHERE `rnumber` = '$academics_1_rnumber' ");
            ...
            $query = mysqli_query($dbconnect, "UPDATE `voting_system` SET `ineligibility` = '$new_ineligibility' WHERE `rnumber` = '$academics_1_rnumber' ");
    ...
    $start_academics_2 = $explode_academics_2[0];
        if($start_academics_2 == "yes"){
            ...
            $query = mysqli_query($dbconnect, "SELECT * FROM `voting_system` WHERE `rnumber` = '$academics_2_rnumber' ");
            while ( $row = mysqli_fetch_array($query) ) {	
                $eligibility = $row['eligibility'];
                $new_eligibility = $eligibility + 1;
            }
            $query = mysqli_query($dbconnect, "UPDATE `voting_system` SET `eligibility` = '$new_eligibility' WHERE `rnumber` = '$academics_2_rnumber' ");
            ...
            $query = mysqli_query($dbconnect, "UPDATE `voting_system` SET `ineligibility` = '$new_ineligibility' WHERE `rnumber` = '$academics_2_rnumber' ");
    ...
    $start_librarian = $explode_librarian[0];
        if($start_librarian == "yes"){
            ...
            $query = mysqli_query($dbconnect, "SELECT * FROM `voting_system` WHERE `rnumber` = '$librarian_rnumber' ");
            while ( $row = mysqli_fetch_array($query) ) {	
                $eligibility = $row['eligibility'];
                $new_eligibility = $eligibility + 1;
            }
            $query = mysqli_query($dbconnect, "UPDATE `voting_system` SET `eligibility` = '$new_eligibility' WHERE `rnumber` = '$librarian_rnumber' ");
            ...
            $query = mysqli_query($dbconnect, "UPDATE `voting_system` SET `ineligibility` = '$new_ineligibility' WHERE `rnumber` = '$librarian_rnumber' ");
    ...
    $start_provost = $explode_provost[0];
        if($start_provost == "yes"){
            ...
            $query = mysqli_query($dbconnect, "SELECT * FROM `voting_system` WHERE `rnumber` = '$provost_rnumber' ");
            while ( $row = mysqli_fetch_array($query) ) {	
                $eligibility = $row['eligibility'];
                $new_eligibility = $eligibility + 1;
            }
            $query = mysqli_query($dbconnect, "UPDATE `voting_system` SET `eligibility` = '$new_eligibility' WHERE `rnumber` = '$provost_rnumber' ");
            ...
            $query = mysqli_query($dbconnect, "UPDATE `voting_system` SET `ineligibility` = '$new_ineligibility' WHERE `rnumber` = '$provost_rnumber' ");
            
        }
            
            $insert_query = mysqli_query($dbconnect, "INSERT INTO `voted_students` SET `rnumber`='$rnumber', level='$level', `full_name`='$full_name', date=NOW() ");
            if($insert_query){
                ?>
...
<?php
$query = mysqli_query($dbconnect, "SELECT * FROM `voting_system` WHERE post='president' ");
...
<?php
$query = mysqli_query($dbconnect, "SELECT * FROM `voting_system` WHERE post='vice_president' ");
...
<?php if(mysqli_num_rows($query)==1){ ?>
 ...
 <?php
$query = mysqli_query($dbconnect, "SELECT * FROM `voting_system` WHERE post='secretary_general' ");
...
<?php
$query = mysqli_query($dbconnect, "SELECT * FROM `voting_system` WHERE post='financial_secretary' ");
...
<?php
$query = mysqli_query($dbconnect, "SELECT * FROM `voting_system` WHERE post='social_1' ");
$counter_social_1=1;
$result = mysqli_num_rows($query);
if(!empty($result)){
?>                                 
...
<?php                                
$query = mysqli_query($dbconnect, "SELECT * FROM `voting_system` WHERE post='social_2' ");
$counter_social_2=1;
$result = mysqli_num_rows($query);
if(!empty($result)){
?>                                 
...
<?php
$query = mysqli_query($dbconnect, "SELECT * FROM `voting_system` WHERE post='software_1' ");
...
<?php
$query = mysqli_query($dbconnect, "SELECT * FROM `voting_system` WHERE post='software_2' ");
...
<?php
$query = mysqli_query($dbconnect, "SELECT * FROM `voting_system` WHERE post='academics_1' ");
...
<?php
$query = mysqli_query($dbconnect, "SELECT * FROM `voting_system` WHERE post='academics_2' ");
...
<?php
$query = mysqli_query($dbconnect, "SELECT * FROM `voting_system` WHERE post='librarian' ");
$counter_librarian=1;
$result = mysqli_num_rows($query);
if(!empty($result)){
?>                                 
...
<?php
$query = mysqli_query($dbconnect, "SELECT * FROM `voting_system` WHERE post='provost' ");
$counter_provost=1;
$result = mysqli_num_rows($query);
if(!empty($result)){
?>                                 
