...
<div class="row fpass_block">
    ...
    <div class="col-md-7 col-md-offset-3 col-sm-12 fpass_body">
        <form role="form" enctype="multipart/form-data" method="post" action="<?php $_SERVER['PHP_SELF'] ?>" class="recover-f">
            ...
            <input type="password" placeholder="Re-enter Password" name="re_pass"  class="form-control f-input">
